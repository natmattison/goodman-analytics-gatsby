  ...
  <StyledSection>
    <ServicesContainer id="services">
      ...
      <ServicesText>
        ...
        What can I learn from the data I have? How can I manage my data more effectively? What analyses may be appropriate for the data I am collecting? What additional pieces of information may be relevant for a particular type of analysis?
        <h5>Statistical analysis</h5>
        Are there trends or patterns in my data that I can learn from? Are there different ways to think about a cost / benefit analysis?  What parts of my data are most meaningful?
        <ul>
        ...
        What exactly do the statistical results mean for my business? What recommendations can you provide based on these results?
